...
const noResultImg = 'https://images.unsplash.com/photo-1573019606806-9695d0a9739d?auto=format&fit=crop&w=1170&q=80';
        ...
        <Box>
            ...
            {properties.length===0 && (
                <Flex justifyContent='center' alignItems='center' flexDir='column' my='5'>
                    <Image src={noResultImg} width={500} height={320} alt='no result' />
